...
config_dir = "config_files/clarc/bone_attacked"
...
for model_name, layer_names in [
    ...
    for artifact_type in [
        ...
        for layer_name in layer_names:
            ...
            lrs = [0.0001] if model_name == "efficientnet_b0" else [0.0005] ## LR after 1 scheduler update
            for lr in lrs:
                base_config['lr'] = lr
                ...
                config_name = f"{model_name}_{artifact_type}_{method}_{optim_name}_lr{lr}_{layer_name}"
                ...
                config_name = f"{model_name}_{artifact_type}_{method}-0epochs_{optim_name}_lr{lr}_{layer_name}"
                store_local(config_vanilla, config_name)
